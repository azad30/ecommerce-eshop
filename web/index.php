				...
				<div class="col-md-3 new-collections-grid">
					<div class="new-collections-grid1 animated wow slideInUp" data-wow-delay=".5s">
						<div class="new-collections-grid1-image">
							<a href="single.php" class="product-image"><img src="../admin/data/<?php echo $row['image']; ?>" width="100%" height="200px" /></a>
							<div class="new-collections-grid1-image-pos">
								<a href="single.php?product=<?php echo $row['id'];?>">Quick View</a>
							</div>
						</div>
						<h4><a href="single.php?product=<?php echo $row['id']; ?>"><?php echo $row['product_name']; ?>t</a></h4>
						<p>Category: <?php echo $row['name']; ?></p>
						<div class="new-collections-grid1-left simpleCart_shelfItem">
							<p><i>$<?php echo $row['discount']; ?></i><span class="item_price">$<?php echo $row['price']; ?></span><a class="item_add" href="single.php?product=<?php echo $row['id']; ?>">View</a></p>
						</div>
					</div>
                    <br>
				</div>
