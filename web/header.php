                ...
                <div class="cart box_1">
                    ...
                    while($row=$read->fetch_array()){
                        if ($row['COUNT(quantity)'] == 0){
                            ?>   <a href="index.php"><img src="images/bag.png">  <div style="margin-top:5px;"><?php echo $row['COUNT(quantity)'].'&nbsp'.'items'; ?></div></a>

                            <?php
                        }
                        else{
                            ?>   <a href="checkout.php"><img src="images/bag.png">  <div style="margin-top:5px;"><?php echo $row['COUNT(quantity)'].'&nbsp'.'items'; ?></div></a>
